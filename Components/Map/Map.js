...
//         console.log(point)
//         console.log(bounds)
//         let inBound = (Math.abs(point[1]) > Math.abs(bounds[0][0]) && Math.abs(point[1]) < Math.abs(bounds[1][0]))
...
//         let amountStepsHeight = 6

//         let stepsWidth = (differenceWidth / amountStepsWidth)
//         let stepsHeight = (differenceHeight / amountStepsHeight)

//         let clusters = []

//         let i = -1
//         while (++i < (amountStepsWidth * amountStepsHeight)) {
//             let currentStepWidth = i % amountStepsWidth
//             let currentStepHeight = Math.floor(i / amountStepsHeight)
//             let centerLat
//             if (latInversed)
